...
@mock.route('/up' , methods = {"POST" , "GET"})
def update():
    return "Working"
...
def update_price(product_pid,product_price):
    ...
    if(current_user.email == "dernli236@gmail.com" and check_password_hash(current_user.password, "!Admin123") ):
        ...
        if prod.price != product_price:    
            ...
            return redirect(url_for( 'homepost_bp.homepost')) #'homepost_bp.home'))
    else: 
